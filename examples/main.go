...
func dyTest() {
	...
	TsSign := "ts.2.9325933b8bf09d548974044a575a30e44f819f094a033643db648fa7ad7fd41bc4fbe87d2319cf05318624ceda14911ca406dedbebeddb2e30fce8d4fa02575d"
	Ticket := "hash.fvsLW/x06mCbBZxVS/RFz/Ly8/P9TdEBGIVKmPHY3mw="
	...
	bdSign, err := bd.NewBDSigner(TsSign, Ticket, EcPrivateKey, EcPublicKey, Cert)
	if err != nil {
		log.Fatalf("创建 bdSign 失败: %v", err)
	}
	dyClient := douyin.New(dyCookie, bdSign)
	// 2. 创建一个带超时的上下文
	ctx, cancel := context.WithTimeout(context.Background(), 30*time.Second)
	defer cancel()
